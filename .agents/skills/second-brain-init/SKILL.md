...
Write `<knowledgeBasePath>/FUNCTIONAL.md` using this template, filled in from what you learned in step 2. Do not invent specs, plans, or session links — those are added by the second-brain-sync skill.
